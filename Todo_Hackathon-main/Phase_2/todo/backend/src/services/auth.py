...
class AuthService:
    ...
    def _truncate_password_to_72_bytes(password: str) -> str:
        ...
        bcrypt has a maximum password length of 72 bytes. This method ensures
        passwords are truncated by byte count (not character count) to prevent
        issues with multi-byte UTF-8 characters.
        ...
        if len(password_bytes) > 72:
            # Truncate to 72 bytes and decode, ignoring incomplete UTF-8 sequences
    ...
    def hash_password(password: str) -> str:
        ...
        password = AuthService._truncate_password_to_72_bytes(password)
    ...
    def verify_password(plain_password: str, hashed_password: str) -> bool:
        ...
        """
        # Ensure password is within bcrypt's 72 byte limit (same as during hashing)
        plain_password = AuthService._truncate_password_to_72_bytes(plain_password)
